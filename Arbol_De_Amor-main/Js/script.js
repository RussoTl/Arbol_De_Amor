...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Sos lo que siempre busqué, mi pareja perfecta.\n\nGracias por aparecer en mi vida y hacerme inmensamente felíz.\n\nTe amo más de lo que las palabras pueden expresar.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Tomy";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2025-08-03T09:30:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-08-03T09:30:00');
  ...
  function update() {
    ...
    container.innerHTML =
      `Llevamos juntos: <b>${Days} días ${Hours} horas ${Minutes} minutos<br> ${Seconds} segundos</b>`;
